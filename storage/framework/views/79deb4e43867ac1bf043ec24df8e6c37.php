<?php $__env->startSection('title', 'Beranda IoT'); ?>
        ...
        <tbody>
            <?php $__empty_1 = true; $__currentLoopData = $devices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $device): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr>
                    ...
                    <td>
    <span
        class="<?php echo e($device->status === 'Online' ? 'status-online' : 'status-offline'); ?>"
        data-device-status="<?php echo e($device->serial_number); ?>"
    >
...
<script>
const isAdmin = "<?php echo e(Auth::user()->role); ?>" === "admin";


const MQTT_HOST = "wss://<?php echo e($mqtt['host']); ?>:<?php echo e($mqtt['ws_port']); ?>/mqtt";
const MQTT_USERNAME = "<?php echo e($mqtt['username']); ?>";
const MQTT_PASSWORD = "<?php echo e($mqtt['password']); ?>";
...
<?php echo $__env->make('layout.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\zaysm\Pictures\myIot\resources\views/beranda.blade.php ENDPATH**/ ?>