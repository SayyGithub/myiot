...
<head>
    <meta charset="UTF-8">
    <title>@yield('title', 'MyIoT Dashboard')</title>
...
<body>
    ...
    <div class="nav-left">
        ...
        <a href="{{ route('sensor.index') }}">Data Sensor</a>
        <a href="{{ route('device.index') }}">Data Device</a>
    </div>
    ...
    <a href="{{ route('password.user.edit') }}" class="nav-action">
        Reset Password
    </a>
@endif
